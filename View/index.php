...
<head>
    ...
    <script src="https://kit.fontawesome.com/01cba61c97.js" crossorigin="anonymous" defer></script>
...
<body <?= isset($_COOKIE['theme'])?'class='.$_COOKIE['theme']:''?>>
    ...
    <main class="container">
        <div class="citation"> 
            <h1>Tous les <span>tutoriels</span></h1>
            <p>envie d'apprendre les maths et comprendre le monde qui vous entourre alors vous êtes au bon endroit.</p>
        </div>
        ...
        <?php foreach($tutos as $tuto):?>
            ...
            <div class="cadre">
                <span class="professeur">Mr <?=getRawById($pdo,"instructeur", $tuto->instructeur, "idInstructeur")->prenom?> <?=getRawById($pdo,"instructeur", $tuto->instructeur, "idInstructeur")->nom?></span>
