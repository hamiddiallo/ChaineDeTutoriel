<?php
    ...
    /*problème  lié au vu  dans ce code*/
    if(isset($_POST['tutoriel'])){
        $idTuto = implode(',',$_POST['tutoriel']);
        supprimerData($pdo,"tutoriel",$idTuto,"id_tuto");
    }
    $records_per_page = 10;
    ...
    $total_records_query = $pdo->query("SELECT COUNT(*) FROM tutoriel ");
    ...
    $Tutos = getFromTablesWithOffset($pdo,"tutoriel",$records_per_page, $offset);
...
<body class="body">
    <nav class="nav-bar">
        ...
        <ul>
            ...
            <li>
                <a href="adminGestionTuto.php" class="activiteEnCours">
    ...
    <main class="content">
        ...
        <div class="cheminTutoriel" style="margin-left:20px;">
            ...
            <a href="gestionEtudiant.php">Tutoriel</a>
        ...
        <div style="margin:25px 10px 20px 21px;display:flex;">
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th>Description</th>
                                <th>Matiere</th>
                                <th style="color:rgb(24, 116, 166);">Instructeur</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <label class="custom-checkbox"> 
                                        <input type="checkbox" value="<?= $tuto->id_tuto?>" name="tutoriel[]">
                                        <span class="checkmark"></span>
                                    </label>
                                </td>
                                <td> <?=$tuto->titre?> </td>
                                ...
                                <td><?=getRawById($pdo,"instructeur", $tuto->instructeur, "idInstructeur")->nom?> <?=getRawById($pdo,"instructeur", $tuto->instructeur, "idInstructeur")->prenom?></td>
                            </tr>
                            <?php endforeach?>
                        </tbody>
                    </table>
            ...
            <div class="tableau2" style="width:25%;transform:translateX(0);height:368px;">
                ...
                <form class="filtrer">
                        ...
                        <button type="submit" class="bouttonSubmit">
                            <i class="fa-solid fa-filter"></i>
                            filtrer
                        </button>
                </form>
