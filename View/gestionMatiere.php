<?php
    ...
    if(isset($_POST['matiere'])){
        $idMat = implode(',',$_POST['matiere']);
        supprimerData($pdo,"matiere",$idMat,"idMat");
    }
    $records_per_page = 10;
    ...
    $matieres = getFromTablesWithOffset($pdo,"matiere",$records_per_page, $offset);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="body">
    <nav class="nav-bar">
        ...
        <ul>
            ...
            <li>
                <a href="gestionMatiere.php" class="activiteEnCours">
    ...
    <main class="content">
        ...
        <div class="cheminTutoriel" style="margin-left:20px;">
            ...
            <a href="gestionMatiere.php">matiere</a>
            <div class="ajouterSupprimer">
                <a href="javascript:void(0)" data-tooltip="ajouter" class="tooltip-container"><i class="fa-solid fa-plus"></i></a>
                <button data-tooltip="supprimer" class="tooltip-container" style="margin-right:23px"><i class="fa-regular fa-trash-can"></i></button>
            </div>
            <div style="clear:right;"></div>
        </div>
        <div style="margin:25px 10px 20px 21px;display:flex;">
            <div class="tableau2" style="transform:translateX(0);width:100%;margin-right:30px;">
                <div style="border-bottom:1px solid rgba(0, 0, 0, 0.175);">
                    <i class="fa-solid fa-list"></i>
                    <span>liste de matiere</span>
                </div>
                <div style="padding:30px;">
                    <form method="POST" id="suppression">
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th style="color:rgb(24, 116, 166);">nom de la matiere</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td style="display:flex;justify-content:center">
                                        <label class="custom-checkbox"> 
                                            <input type="checkbox" name="matiere[]" value="<?= $matiere->idMat?>">
                                            <span class="checkmark"></span>
                                        </label>
                                    </td>   
                        ...
                        <div class="popup" style="display:none;">
                            ...
                            <form id="editForm" method="post" action="Controlleur/controlMatiere.php" enctype="multipart/form-data">
    ...
    <script>
            ...
            document.querySelector('.tooltip-container').addEventListener(
                'click',function (){
                    document.querySelector('.popup').style.display = "block"
                    gsap.fromTo(document.querySelector('.popup'),{
                        y:-40,
                        opacity:0
                    },{
                        y:5,
